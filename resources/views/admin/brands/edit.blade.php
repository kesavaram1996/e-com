...
<section class="section">
    <div class="section-header mt">
        <div class="row">
            ...
            <div class="col-6 col-md-6 col-lg-6">
                {{ Breadcrumbs::render('brands/edit') }}
            </div>
        </div>
    </div>
            ...
            <div class="col-sm-12">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">{{ __('brands.edit_brand') }}</h6>
                        </div>
                            ...
                            <div class="form-wrap">
                                ...
                                <form action="{{route('brands.update',$datas->id)}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mb-30">
                                        ...
                                        <img src="{{ asset('images/'.$datas->image) }}" alt="{{ __('brands.brand_image') }}" width="200px">
                                    </div>
