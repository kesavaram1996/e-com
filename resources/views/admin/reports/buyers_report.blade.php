    ...
    <div class="section-header mt">
        <div class="row">
            <div class="col-6 col-md-6 col-lg-6">
                <h3>{{ __('buyers_report.buyers_report') }}</h3>
            </div>
            <div class="col-6 col-md-6 col-lg-6">
                {{ Breadcrumbs::render('buyers_report') }}
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mt">
                <div class="panel panel-default card-view panel-refresh">
                    ...
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">{{ __('buyers_report.buyers_report') }}</h6>
                        </div>
                    ...
                    <div class="panel-wrapper collapse in">
                        ...
                        <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 mt-25">
                                    <div class="ml-50">
                                        <label><strong>Filter by Buyers</strong></label>
                                        <select id='buyer_filter' class="form-control" style="width: 200px">
                            ...
                            <div class="table-wrap">
                                <div class="table-responsive">
                                    <table class="table table-bordered data-table table-hover ml-20" style="width:97%;">
                                        <thead>
                                            <tr>
                                                <th>{{ __('buyers_report.id') }}</th>
                                                <th>{{ __('buyers_report.name') }}</th>
                                                <th>{{ __('buyers_report.mobile') }}</th>
                                                <th>{{ __('buyers_report.final_total') }}</th>
                                                <th>{{ __('buyers_report.payment_method') }}</th>
                                                <th>{{ __('buyers_report.active_status') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
