    ...
    <div class="section-header mt">
        <div class="row">
            <div class="col-6 col-md-6 col-lg-6">
                <h3>{{ __('top_selling_products.top_selling_products') }}</h3>
            </div>
            <div class="col-6 col-md-6 col-lg-6">
                {{ Breadcrumbs::render('top_selling_products') }}
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mt">
                <div class="panel panel-default card-view panel-refresh">
                    ...
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">{{ __('top_selling_products.top_selling_products') }}</h6>
                        </div>
                            ...
                            <div class="table-wrap">
                                <div class="table-responsive">
                                    <table class="table table-bordered data-table table-hover ml-20" style="width:97%;">
                                        <thead>
                                            <tr>
                                                <th>{{ __('top_selling_products.product_name') }}</th>
                                                <th>{{ __('top_selling_products.unit') }}</th>
                                                <th>{{ __('top_selling_products.quantity') }}</th>
                                                <th>{{ __('top_selling_products.order_count') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        ...
        ordering: false,
        ajax: {
          url: "{{ route('top_selling_products') }}",
          data: function (d) {
