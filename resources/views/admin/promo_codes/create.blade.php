...
<section class="section">
    <div class="section-header mt">
        <div class="row">
            ...
            <div class="col-6 col-md-6 col-lg-6">
                {{ Breadcrumbs::render('promo_codes/add') }}
            </div>
        </div>
    </div>
            ...
            <div class="col-sm-12">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">{{ __('promo_codes.add_promo_code') }}</h6>
                        </div>
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="form-wrap">
                                <form action="{{route('promo_codes.store')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <!-- promo_code -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="no_of_users" class="form-control" value="{{ old('no_of_users') }}">
                                    </div>
                                    <!-- minimum_order_amount -->
                                    <div class="form-group">
                                        <label class="control-label mb-10 text-left">{{ __('promo_codes.minimum_order_amount') }}</label>
                                        <input type="number" name="minimum_order_amount" class="form-control" value="{{ old('minimum_order_amount') }}">
                                    </div>
                                    <!-- discount -->
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="discount_type" id="discount_type" class="form-control">
                                            ...
                                            <option value="percentage">{{ __('promo_codes.percentage') }}</option>
                                            <option value="amount">{{ __('promo_codes.amount') }}</option>
                                        </select>
                                    </div>
                                    <!-- max_discount_amount -->
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="repeat_usage" id="repeat_usage" class="form-control">
                                            ...
                                            <option value="allowed">{{ __('promo_codes.allowed') }}</option>
                                            <option value="not_allowed">{{ __('promo_codes.not_allowed') }}</option>
                                        </select>
                                    </div>
                                    <!-- no_of_repeat_usage -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-control">
                                            ...
                                            <option value="active">{{ __('promo_codes.active') }}</option>
                                            <option value="deactive">{{ __('promo_codes.deactive') }}</option>
                                        </select>
                                    </div>
                                    <div class="form-group mb-30 text-center">
                                        <button type="submit" class="btn btn-primary">{{ __('promo_codes.submit') }}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
