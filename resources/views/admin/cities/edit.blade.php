...
<section class="section">
    <div class="section-header mt">
        <div class="row">
            ...
            <div class="col-6 col-md-6 col-lg-6">
                {{ Breadcrumbs::render('cities/edit') }}
            </div>
        </div>
    </div>
            ...
            <div class="col-sm-12">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">{{ __('cities.edit_city') }}</h6>
                        </div>
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="form-wrap">
                                ...
                                <form action="{{route('cities.update',$datas->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group mb-30 text-center">
                                        <button type="submit" class="btn btn-primary">{{ __('cities.update') }}</button>
                                    </div>
                                </form>
                                @endforeach
                            </div>
